...
class GraphAttention(nn.Module):
    ...
    def forward(self, query_nodes, key_nodes, value_nodes, edge_mask=None):
...
if __name__ == '__main__':
    ...
    # split_lens = [50, 15, 46, 375, 500]
    # mha = GraphAttention(embed_dim=768, num_heads=1)
    # mask = get_intra_mask(split_lens)
    # input = torch.randn(32, sum(split_lens), 768).permute(1, 0, 2)
    # o = mha(query=input, key=input, value=input, attn_mask=mask)
